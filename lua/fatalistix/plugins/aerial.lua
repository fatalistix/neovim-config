...
return {
    ...
    config = function(_, opts)
        ...
        vim.keymap.set('n', '<leader>ac', aerial.close, { desc = 'Close aerial' })
        vim.keymap.set('n', '<leader>ah', function()
            aerial.toggle({ direction = 'Toggle left aerial' })
        end, { desc = 'Toggle left' })
        vim.keymap.set('n', '<leader>al', function()
            aerial.toggle({ direction = 'Toggle right aerial' })
        end, { desc = 'Toggle right' })
        vim.keymap.set('n', '<leader>af', function()
            aerial.toggle({ direction = 'Toggle float aerial' })
        end, { desc = 'Toggle float' })
        vim.keymap.set('n', '<esc>', function()
            aerial.close()
        end, { desc = 'Close aerial' })
